...
// dist/constants/webgl-constant-utils.js
function createGLKeyByValue(gl) {
  const keyByValue = /* @__PURE__ */ new Map();
  for (const key in gl) {
    const value = gl[key];
    if (key < "a") {
...
var init_webgl_constant_utils = __esm({
  "dist/constants/webgl-constant-utils.js"() {
  }
});
