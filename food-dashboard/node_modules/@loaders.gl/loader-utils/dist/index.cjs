...
var requestId = 0;
async function createLoaderWorker(loader, selectLoader = () => loader) {
...
async function parseData({ loader, arrayBuffer, options, context }) {
  ...
  const workerModules = Object.fromEntries(Object.entries(options.modules || {}).filter(([, value]) => typeof value === "string"));
  options = {
    ...options,
    modules: {
...
async function parseWithWorker(loader, data, options, context, parseOnMainThread2) {
  ...
  options._workerLoaderId = loader.id;
...
// dist/json-loader.js
var VERSION2 = true ? "4.5.2" : "latest";
var JSONLoader = {
  dataType: null,
  batchType: null,
  name: "JSON",
