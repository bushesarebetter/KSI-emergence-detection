  ...
  return (
    <PageFrame onNavigate={onNavigate}>
      ...
      <p className="mt-5 max-w-[46ch] font-serif text-[17px] leading-[1.55] text-ink-2">
        The map lives at <span className="font-mono text-[14px]">/map</span>. A link to one place
        looks like <span className="font-mono text-[14px]">/map?place=43</span>, where the number
        is its rank, and <span className="font-mono text-[14px]">/place/43</span> is that place on
        its own page.
      </p>
