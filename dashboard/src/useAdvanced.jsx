...
const KEY = "ksi.advancedMode";
const SEEN_KEY = "ksi.seenWelcome";

const AdvancedContext = createContext(null);

// localStorage throws in private mode and in some embedded webviews, and the
// dashboard must render correctly without it -- these preferences are a
// convenience, never load-bearing state.
...
export function AdvancedProvider({ children }) {
  // Plain is the default. A first-time visitor should never have to decode an
  // acronym to work out what they are looking at.
